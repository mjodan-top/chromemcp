...
export class ResultScene extends Phaser.Scene {
  ...
  init(data: { level: Level; time: number; moves: number; stars: number }): void {
  ...
  private createCelebration(width: number, height: number): void {
    // 简单的粒子效果
  ...
  private createStatCard(x: number, y: number, cardWidth: number, value: string, label: string): Phaser.GameObjects.Container {
